...
public class MainController implements Initializable {
    ...
    @FXML
    TableColumn<List<StringProperty>,String> clId, clName, clIdProduct, clDate,clQte,clRaison;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        clIdProduct.setCellValueFactory(data -> data.getValue().get(2));
    ...
    private void ActionAdd(){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/DamageProductViews/AddView.fxml"));
    ...
    private void ActionUpdate(){
        ...
        if (data != null){
            ...
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/DamageProductViews/UpdateView.fxml"));
                DialogPane temp = loader.load();
            ...
            alertWarning.setContentText("الرجاء اختيار تلف من اجل التعديل");
            ...
            try {
                ...
                alertConfirmation.showAndWait().ifPresent(response -> {
                    if (response == ButtonType.CANCEL) {
                        ...
                        ArrayList<ComponentDamage> damages = componentDamageProductOperation.getAllByDamage(damage.getId());
    ...
    private void deleteComponentDamage(ArrayList<ComponentDamage> componentDamages){
        for (ComponentDamage selectDamage : componentDamages){
            ComponentStoreProduct store = componentStoreProductOperation.get(selectDamage.getIdComponent(),selectDamage.getIdReference());
            store.setQteConsumed(store.getQteConsumed() - selectDamage.getQte());
            updateQteComponentStoreProduct(store);
            componentDamageProductOperation.delete(selectDamage);
        }
    }
    ...
    private void refresh(){
        try {
            ...
            String query = "SELECT * FROM اتلاف_المنتجات, المنتجات WHERE اتلاف_المنتجات.معرف_المنتج = المنتجات.المعرف;";
            ...
            while (resultSet.next()){
                ...
                data.add( new SimpleStringProperty(String.valueOf(resultSet.getInt("معرف_المنتج"))));
