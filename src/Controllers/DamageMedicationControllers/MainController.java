...
public class MainController implements Initializable {
    ...
    @FXML
    TableColumn<List<StringProperty>,String> clId, clName, clIdMedication, clDate,clQte,clRaison;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        clIdMedication.setCellValueFactory(data -> data.getValue().get(2));
    ...
    private void ActionAdd(){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/DamageMedicationViews/AddView.fxml"));
    ...
    private void ActionUpdate(){
        ...
        if (data != null){
            ...
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/DamageMedicationViews/UpdateView.fxml"));
                DialogPane temp = loader.load();
            ...
            try {
                ...
                alertConfirmation.showAndWait().ifPresent(response -> {
                    if (response == ButtonType.CANCEL) {
                        ...
                        ArrayList<ComponentDamage> damages = componentDamageMedicationOperation.getAllByDamage(damage.getId());
    ...
    private void refresh(){
        try {
            ...
            String query = "SELECT * FROM اتلاف_الادوية, الادوية WHERE اتلاف_الادوية.معرف_الدواء = الادوية.المعرف;";
